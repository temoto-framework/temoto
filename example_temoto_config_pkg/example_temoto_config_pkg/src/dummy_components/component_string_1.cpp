...
{
  ros::init(argc, argv, "component_string_1_node");
  ros::NodeHandle nh;

  // Test publishers
  pub_0 = nh.advertise<std_msgs::String>("cs_1_pub_0", 10);
  pub_1 = nh.advertise<std_msgs::String>("cs_1_pub_1", 10);

  // Test subscribers
  ros::Subscriber sub_0 = nh.subscribe( "cs_1_sub_0", 10, sub0Cb);
  ros::Subscriber sub_1 = nh.subscribe( "cs_1_sub_1", 10, sub1Cb);

  std::cout << "component_string_1 READY\n";
